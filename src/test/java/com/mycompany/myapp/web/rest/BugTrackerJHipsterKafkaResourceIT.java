...
class BugTrackerJHipsterKafkaResourceIT {
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/bug-tracker-j-hipster-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/bug-tracker-j-hipster-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
